...
public class MadlibFileFillerTest {
    ...
    void testFillInMadlib() throws TextNotProcessedException, IOException {
        ...
        Madlib_File testMadlibFile = new Madlib_File(textForFile, outputFile1.toString(), 1);
        ...
        testMadlibFile.fillInMadlib(replacementWords1, outputFile2.toString());
        assertEquals(test1, Files.readString(outputFile2));

        testMadlibFile.fillInMadlib(replacementWords2, outputFile3.toString());
