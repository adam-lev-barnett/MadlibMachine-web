 ...
 * @see adam_barnett.madlibs.madlib_machine.userinterface.CLI*/
...
class MadlibFiller {
    ...
    void fillInMadlib(BufferedWriter writer, @NotNull String blankedMadlib, Queue<String> replacementWords) throws IOException {
        ...
        for (String word : words) {
            ...
            if (Madlib_File.getPosMap().containsValue(strippedWord) && replacementWords.peek() != null) {
        ...
        System.out.println("Madlib_File successfully populated and saved to the src folder!");
    }
