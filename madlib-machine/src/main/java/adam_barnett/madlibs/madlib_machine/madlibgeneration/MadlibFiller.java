...
public class MadlibFiller {
    ...
    public String fillInMadlib(@NotNull String blankedMadlib, Queue<String> replacementWords) {
        ...
        for (String word : wordList) {
            ...
            if (PosMap.posMap.containsValue(strippedWord) && replacementWords.peek() != null) {
    ...
    private static void replaceWord(Queue<String> replacementWords, @NotNull String lastChar, boolean lastWord, StringBuilder sb) {
